      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error loging out! Try again');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error signing up! Try again');
...
var stripe = Stripe('pk_test_51LIAgUKIRyQuaqxolcFYAWrUpygUozh1DrRimha3s0MuVE5vCbBCg92JmKiv0qGHq49xaGTOsMtMP5ohl9drzCgC00BhdlMQAU');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            console.log('Error in Stripe.js', _context.t0);
